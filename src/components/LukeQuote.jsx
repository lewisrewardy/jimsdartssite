...
export default function LukeQuote() {
  return (
    <section
      className="w-full"
      style={{ backgroundColor: '#0a0a0a', borderTop: '0.5px solid #222222', borderBottom: '0.5px solid #222222' }}
    >
      <div className="grid grid-cols-1 md:grid-cols-2 max-w-7xl mx-auto">
        ...
        {/* Quote side */}
        <div className="flex flex-col justify-center px-8 md:px-12 py-14" style={{ backgroundColor: '#0a0a0a' }}>
          {/* Label */}
          <p
          ...
          {/* Quote */}
          <blockquote className="text-2xl md:text-3xl font-bold uppercase leading-snug mb-6 text-white">
          ...
          <Link
            to="/why-smarter"
            className="text-sm font-semibold transition-opacity duration-150 hover:opacity-75"
            style={{ color: '#c8102e' }}
          >
            Read the full story →
          </Link>
